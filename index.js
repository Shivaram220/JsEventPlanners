...
// let navIt = document.getElementsByClassName('nav-items-respo')
...
//     setTimeout(() => {
//         const entireBody = document.getElementsByClassName('entire-body');
//         const initialBackIm = document.getElementsByClassName('initial-background-image');
//         entireBody[0].style.display = 'flex';
//         // entireBody[0].style.flex;
//         initialBackIm[0].style.display = 'none';
//     },2000);
// })
